...
// Fetch category data
$sql = "SELECT * FROM expense_categories WHERE id = '$category_id'";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE expense_categories SET name = '$name' WHERE id = '$category_id'";
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Edit Expense Category</h1>
</div>
...
<form action="edit_expense_category.php?id=<?php echo $category_id; ?>" method="post">
